...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_icon = Image(
            page,f'{identifier}-image-upload-widget-info-icon', 'Image Icon'
        )
        self.image_upload_info_title = Text(
            page,f'{identifier}-image-upload-widget-info-title-text', 'Image Title'
        )
        self.image_upload_info_description = Text(
            page,f'{identifier}-image-upload-widget-info-description-text', 'Image Description'
        )
