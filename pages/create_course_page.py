...
class CreateCoursePage(BasePage):
    def __init__(self, page: Page):
        ...
        # Course Title and Create Button
        self.create_course_title = page.get_by_test_id('create-course-toolbar-title-text')
        self.create_course_button = page.get_by_test_id('create-course-toolbar-create-course-button')

        # Preview image and course image preview block
        ...
        # Button for uploading and deleting a course preview image and a block with information about the image being uploaded
        ...
        # Block that will be displayed when there are no assignments in the course
